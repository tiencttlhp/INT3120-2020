               ...
               <View >
                    ...
                    <View style={{marginTop:15,backgroundColor:"#FFFFFF"}}>
                        <View style={{marginLeft:15,marginRight:15}}>
                            ...
                            <Text style={{fontSize:20, marginBottom:10, color:'#0000FF', marginTop:20, borderBottomColor:"#A4A4A4", borderBottomWidth:2}}>Câu hỏi xe hình</Text>
                            ...
                            <Text style={{fontSize:20, marginBottom:10, color:'#0000FF', marginTop:20, borderBottomColor:"#A4A4A4", borderBottomWidth:2}}>Trong giao lộ</Text>
